...
const Input = ({ name, value, handleInput, placeholder, error, required, type = 'text' }) => (
  <div className="flex flex-col w-full">
    <label htmlFor={name} className="font-changa text-sm uppercase tracking-[0.25em] text-white/60 mb-2">
      {placeholder}
      {required && (
    ...
    >
      ...
      <div className="col-span-12">
        ...
        <div className="flex items-center justify-end mt-1.5">
          <span
            className={`font-changa text-sm tracking-widest transition-colors ${
