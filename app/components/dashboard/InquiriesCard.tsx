      ...
      <div className="bg-surface-dark border border-border-dark flex flex-col h-full hover:border-white/10 transition-colors overflow-hidden">
        ...
        <div className="shrink-0 flex items-center justify-between px-3 py-2 border-b border-border-dark">
          ...
          <div className="flex items-center gap-1.5">
            {potentialSpam > 0 && (
              <span className="text-[9px] font-mono uppercase tracking-widest px-1.5 py-0.5 border text-orange-400 border-orange-400/30 bg-orange-400/5 flex items-center gap-1">
            ...
            {pending > 0 && (
              <span className="text-[9px] font-mono uppercase tracking-widest px-1.5 py-0.5 border text-amber-400 border-amber-400/30 bg-amber-400/5 flex items-center gap-1">
        ...
        {pending > 0 && (
          <div className="shrink-0 border-b border-amber-400/20 bg-amber-400/5 overflow-hidden py-0.5">
            ...
            >
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <span key={i} className="text-[9px] font-mono text-amber-400/60 pr-8">
        ...
        {potentialSpam > 0 && (
          <div className="shrink-0 border-b border-orange-400/20 bg-orange-400/5 overflow-hidden py-0.5">
            ...
            >
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <span key={i} className="text-[9px] font-mono text-orange-400/60 pr-8">
        ...
        <div className="flex-1 min-h-20 760:min-h-auto flex items-center divide-x divide-border-dark overflow-hidden">
          {potentialSpam > 0 && (
            <div className="flex-1 flex flex-col items-center justify-center gap-0.5 py-1 min-w-0">
              ...
              <span className="text-[9px] font-mono uppercase tracking-widest text-orange-400/50">Flagged</span>
            </div>
          )}
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-0.5 py-1 min-w-0">
            ...
            <span className="text-[9px] font-mono uppercase tracking-widest text-muted-dark/70">Pending</span>
          </div>
          <div className="flex-1 flex flex-col items-center justify-center gap-0.5 py-1 min-w-0">
            <span className="font-mono font-bold tabular-nums leading-none text-xl text-text-dark">{responded}</span>
            <span className="text-[9px] font-mono uppercase tracking-widest text-muted-dark/70">Responded</span>
          </div>
        </div>
      </div>
    </Link>
