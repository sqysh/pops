  ...
  return (
    <div className="shrink-0 h-9 bg-navbar-dark border-b border-border-dark flex items-center justify-between px-4">
      <div className="flex items-center gap-3">
        <span className="text-[9px] font-mono tracking-[0.2em] uppercase text-text-dark">THE POPS ORCHESTRA</span>
      </div>
      <div className="flex items-center gap-4">
        ...
        <span className="text-[9px] font-mono text-muted-dark/60">{email}</span>
        <span
        ...
        <Link
          href="/auth/logout"
          aria-label="Log out"
          className="text-muted-dark/40 hover:text-red-400 transition-colors"
        >
