        ...
        <>
          ...
          >
            ...
            <div className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-border-dark">
              <span className="text-[9px] font-mono text-muted-dark/70 uppercase tracking-widest">[ APPLICATION ]</span>
              <button
                onClick={onClose}
              ...
              <div className="px-4 py-4 flex flex-col gap-5">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">Submitted</span>
                  ...
                  <div className="flex flex-col items-end gap-1">
                    <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">Instrument</span>
                ...
                {s && (
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">Student</span>
                    </div>
                    <div className="bg-surface-dark border border-border-dark px-3 py-3 flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[8px] font-mono text-muted-dark">Grade {s.grade}</span>
                      </div>
                      <span className="text-[9px] font-mono text-muted-dark">{s.school}</span>
                      <div className="flex flex-col gap-1 pt-1 border-t border-border-dark/40">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            ...
                            className="text-[9px] font-mono text-muted-dark hover:text-text-dark transition-colors"
                          >
                ...
                {p && (
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">
                        Parent / Guardian
                      </span>
                    </div>
                    <div className="bg-surface-dark border border-border-dark px-3 py-3 flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        ...
                        {p.relationshipToStudent && (
                          <span className="text-[8px] font-mono text-muted-dark uppercase tracking-widest">
                            {p.relationshipToStudent}
                          </span>
                        )}
                      </div>
                ...
                {a && (a.addressLine1 || a.city) && (
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">Address</span>
                    </div>
                    <div className="bg-surface-dark border border-border-dark px-3 py-3">
                      <p className="text-[9px] font-mono text-muted-dark leading-relaxed">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark">Music Info</span>
                  </div>
                    ...
                    {[
                      ...
                      .map(({ label, value }) => (
                        <div key={label} className="flex flex-col gap-0.5">
                          <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark/70">
                            {label}
                          </span>
                          <span className="text-[9px] font-mono text-text-dark/80">{value}</span>
                        </div>
                      ))}
                    {/* Consent */}
                    <div className="flex items-center justify-between pt-1 border-t border-border-dark/40">
                      <span className="text-[7px] font-mono uppercase tracking-widest text-muted-dark/70">Consent</span>
                      <span
            ...
            <div className="shrink-0 flex items-center justify-end px-4 py-3 border-t border-border-dark bg-surface-dark">
              <button
                type="button"
                onClick={onClose}
                className="text-[8px] font-mono uppercase tracking-widest px-3 py-1.5 border border-border-dark text-muted-dark hover:text-text-dark hover:border-muted-dark/30 transition-colors"
              >
                Close
              </button>
            </div>
